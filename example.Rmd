...
![Mueller-Watson significance without controlling for trends, and applying a default average correlation of 0.03 is 0.03. This is far from the randomized value of 0.38 suggesting that the standard error correction is not reliable here.](mw_03.png)
...
![Mueller-Watson significance without controlling for trends, but applying an average correlation of 0.10 is 0.08, again a long way from the more conservative randomized value.](mw_10.png)
...
```{r MW_corr_trend, cache=TRUE}

round(avg_correlation(study,frm=frml_trend,Range_Search=seq(100,400,by=10)),3)

```

![Mueller-Watson significance after controlling for trends is 0.73, close to the randomized value of 0.70](mw_trend_03.png)
